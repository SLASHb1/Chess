...
bool Identity::chessKing(int initialTile, int finalTile, string alliance, int* arrOfChess) {
...
bool Identity::chessQueen(int initialTile, int finalTile, string alliance, int* arrOfChess) {
...
bool Identity::chessPawn(int initialTile, int finalTile, string alliance, int* arrOfChess) {
...
bool Identity::chessRook(int initialTile, int finalTile, string alliance, int* arrOfChess) {
...
bool Identity::chessBishop(int initialTile, int finalTile, string alliance, int* arrOfChess) {
...
bool Identity::chessKnight(int initialTile, int finalTile, string alliance, int* arrOfChess) {
...
string Identity::checkAlliance(int piece) {
    if (piece > 0) {
        return "white";
    }
    else if (piece < 0) {
